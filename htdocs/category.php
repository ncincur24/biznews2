                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="section-title">
                                    ...
                                    <a class="text-secondary font-weight-medium text-decoration-none" href="all-news.php?filter=1&cat=<?=$c->category_id?>">View All</a>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center bg-white mb-3 nemanja" style="height: 110px;">
                                        ...
                                        <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                            <div class="mb-2">
                                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href="all-news.php?filter=1&cat=<?=$c->category_id?>"><?=$c->name?></a>
                                                <a class="text-body" href=""><small><?=date("l, j M Y", strtotime($tc->date))?></small></a>
                                            </div>
