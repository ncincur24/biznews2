        ...
        <div class="row py-4">
            <div class="col-lg-4 col-md-6 mb-5">
                ...
                <div class="d-flex justify-content-start">
                    ...
                    <?php endforeach?>
                    <a class="btn btn-lg btn-secondary btn-lg-square mr-2" href="documentation.pdf"><i class="fa fa-file-text"></i></i></a>                    
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mb-5">
                ...
                <div class="mb-3">
                    ...
                    <a class="small text-body text-uppercase font-weight-medium" href="single.php?single=<?=$t->news_id?>">
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                ...
                <div class="m-n1">
                    <?php foreach($categories as $c):?>
                        <a href="all-news.php?filter=1&cat=<?=$c->category_id?>" class="btn btn-sm btn-secondary m-1"><?=$c->name?></a>
                    <?php endforeach?>    
                </div>
            </div>
        </div>
