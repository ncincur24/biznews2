                ...
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-4">
                                ...
                                href="all-news.php?filter=1&cat=<?=$new->category_id?>"><?=$new->name?></a>
                    ...
                    <?php else:?>
                        <div class="mb-3">
                            <div class="section-title mb-0">
                                <p class="m-0">You want to post comment please <a href="login.php">login</a> or <a href="registration.php">register</a></p>
                            </div>
                        </div>
                    <?php endif?> 
                    <!-- Comment Form End -->
