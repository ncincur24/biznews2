                    ...
                    <?php foreach($headline as $key=>$h):?>
                        <?php if($key > 2) break;?>
                            <div class="position-relative overflow-hidden" style="height: 500px;">
                                ...
                                <div class="overlay">
                                    <div class="mb-2">
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2 float-left category-btn"
                                        href="#" data-view="<?=$h->category_id?>"><?=$h->name?></a>
                                        <p class="text-white mb-0 ml-3 float-left"><?=date("l, j M Y", strtotime($h->date))?></p>
                                    </div>
                                    <a class="h2 m-0 text-white text-uppercase font-weight-bold" href="index.php?page=single&single=<?=$h->news_id?>">
                        ...
                        <div class="col-md-6 px-0">
                            <div class="position-relative overflow-hidden" style="height: 250px;">
                                ...
                                <div class="overlay">
                                    ...
                                    <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="index.php?page=single&single=<?=$h->news_id?>">
                            ...
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    ...
                                    <div class="bg-white border border-top-0 p-4">
                                        <div class="mb-2">
                                            <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2 category-btn"
                                            href="#" data-view="<?=$h->category_id?>"><?=$h->name?></a>
                                            <p><small><?=date("l, j M Y", strtotime($h->date))?></small></p>
                                        </div>
                                        <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="index.php?page=single&single=<?=$h->news_id?>">
